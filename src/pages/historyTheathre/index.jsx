...
import { ShowPhoto } from '../../components/play'
            ...
            <div className={styles.infoBlock_1}>
              <div className={styles.infoBlock_1_1}>
                ...
                <div>
                  ...
                  постановки мгновенно определили дальнейший стиль «Театра
                  Луны».
                </div>
              ...
              <div className={styles.infoBlock_1_2}>
                ...
                <div>
                  ...
                  <p>
                    «Театр Луны» с первого спектакля продемонстрировал
                    незаурядное мастерство, дерзость и смелость художественных
                    замыслов, редкое умение овладевать любым сценическим
                    пространством.
                  </p>
                </div>
              </div>
            ...
            <div className={styles.infoBlock_2}>
              <div className={styles.infoBlock_2_1}>
                ...
                <div>
                  ...
                  <p>
                    — «Путешествие дилетантов» с нежной и хрупкой Ольгой
                    Понизовой и величественным Валентином Смирницким
                  </p>
                  <p>
              ...
              <div className={styles.infoBlock_2_2}>
                ...
                <div>
                  ...
                  дебютировала ученица Сергея Проханова Анастасия Стоцкая
                  (мюзикл «Губы»). На сцене «Театра Луны» играли Никита
                  Высоцкий, Юрий Чернов, Вера Сотникова и многие другие
                ...
                <div>
                  <div>
                    <p>
                      ...
                      прекрасно оборудованное театральное здание на Малой
                      Ордынке. Появились новые авторы, режиссеры, жанры,
                      подрастает талантливая молодежь.
                    </p>
                    <p>
          ...
          <div className={styles.historyContainer}>
            ...
            <div className={styles.infoBlock_2_7}>
              <div>
                <div className={styles.infoBlock_2_7_info_1}>
                  ...
                  <span>средства собирали по всей стране</span>, продавая
                  открытки с видами памятников и изображением произведений
                  мирового искусства. Однако, большую часть средств дали
                  благотворители, а не открытки. Но сумма сбора от их продаж
                  позволила купить библиотеку и меблировку для этого учреждения.
                </div>
            ...
            <div className={styles.infoBlock_2_9}>
              <div className={styles.photoBlock}>
                <ShowPhoto photo={getSliderPhoto(this.state.items)} />
              </div>
            </div>
          </div>
        </main>
