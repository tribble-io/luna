        ...
        <div className={styles.contactInfo}>
          <div className={styles.contactList}>
            <div className={styles.contactBlock}>
              ...
              <a className={styles.contactLink} href='tel:84959531317'>
                +7 (495) 953-13-17
              </a>
            ...
            <div className={styles.contactBlock}>
              ...
              <a className={styles.contactLink} href='tel:84959377737'>
                +7 (495) 937-77-37
              </a>
              <p className={styles.subTitle}>email</p>
              <a
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959531121'>
                +7 (495) 953-11-21
              </a>
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959530561'>
                +7 (495) 953-05-61
              </a>
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959510131'>
                +7 (495) 951-01-31 (приемная)
              </a>
              <a className={styles.contactLink} href='tel:84959530209'>
                +7 (495) 953-02-09
              </a>
              <a className={styles.contactLink} href='tel:84959515587'>
                +7 (495) 951-55-87
              </a>
            </div>
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959515788'>
                +7 (495) 951-57-88 (приемная)
              </a>
              <a className={styles.contactLink} href='tel:84959530442'>
                +7 (495) 953-04-42
              </a>
            </div>
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959530941'>
                +7 (495) 953-09-41
              </a>
              <p className={styles.text}>
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959530008'>
                +7 (495) 953-00-08
              </a>
              <p className={styles.subTitle}>email</p>
              <a
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959515544'>
                +7 (495) 951-55-44
              </a>
              <p className={styles.subTitle}>email</p>
              <a className={styles.contactLink} href='mailto:zt-moon@yandex.ru'>
                zt-moon@yandex.ru
              </a>
            </div>
            ...
            <div className={styles.contactBlock}>
              ...
              <p className={styles.text}>???</p>
              <p className={styles.subTitle}>телефон</p>
              <a className={styles.contactLink} href='tel:84959530847'>
                +7 (495) 953-08-47
              </a>
            </div>
          </div>
