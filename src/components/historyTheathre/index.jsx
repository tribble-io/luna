            ...
            <section>
                ...
                <div className={styles.infoBlock_1}>
                        <div className={styles.infoBlock_1_1}>
                            <div>
                                История "Театра Луны" берет начало в 1992 году со спектакля-концерта
                                "Уникальный голос" студии фантастики «Луна», основанной Сергеем Прохановым.
                                Усилиями его и тех людей, которых он сплотил вокруг себя, очень скоро небольшой
                                подвальчик в Большом Козихинском переулке рядом с Патриаршими прудами
                                превратился в центр притяжения для театральной публики. Однако <span>днем рождения
                                "Театра Луны" считается дата — 14 февраля 1993 года</span>, когда Сергей Проханов
                                представил московской театральной публике спектакль «Византия» по романтической
                                трагедии Николая Гумилева «Отравленная туника».
                            </div>
                            <div>
                                Роковая интрига, страсть, романтика, таинственность этой
                                постановки мгновенно определили дальнейший стиль «Театра Луны».
                            </div>
                            <div className={styles.infoBlock_1_1_el_1}><div></div></div>
                            <div>
                                В 1994 году студия получила государственный статус и была преобразована
                                в Московский театр «Театр Луны» под руководством Сергея Проханова.
                            </div>
                            <div className={styles.infoBlock_1_2_img_bl_2}><div></div></div>
                        </div>
                        <div className={styles.infoBlock_1_2}>
                            <div className={styles.infoBlock_1_2_img_bl_1}><div></div></div>
                            <div className={styles.infoBlock_1_2_img_bl_2}><div></div></div>
                            <div>
                                <p>Само название театра говорит о его романтической направленности. Луна — это самое близкое женское космическое тело,
                                которое притягивает всех нас. Она будоражит фантазию, манит к себе, вызывая самые поэтические ассоциации.</p>

                                <p>«Театр Луны» с первого спектакля продемонстрировал незаурядное мастерство, дерзость и смелость художественных
                                замыслов, редкое умение овладевать любым сценическим пространством.</p>
                            </div>
                        </div>
                </div>
                ...
                <div className={styles.infoBlock_1_mob}>
                        <div className={styles.infoBlock_1_1_mob}>
                            ...
                            <div className={styles.infoBlock_1_1_mob_1el}><div></div></div>
                            ...
                            <div className={styles.infoBlock_1_1_mob_2el}><div></div></div>
                            ...
                            <div className={styles.infoBlock_1_1_mob_3el}><div></div></div>
                ...
                <div className={styles.infoBlock_2}>
                        <div className={styles.infoBlock_2_1}> 
                            <div>
                                ...
                                <p>— «Византия» с прекрасной Ириной Метлицкой, «Ночь нежна», где блистали
                                    Анатолий Ромашин, Сергей Виноградов, Дмитрий Певцов, Марина Блэйк и
                                    будущая звезда театра Елена Захарова
                                </p>
                            ...
                            <div className={styles.infoBlock_2_1_2222}><img src={group2} /></div>
                                ...
                                <p>— Мужественный, ослепительный Александр Македонский в
                                    исполнении Андрея Соколова и пленительная, изящно-изысканная Таис – Анна Терехова.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className={styles.infoBlock_2_3}> 
                            <div>
                            При театре существует <span>детская театральная студия «Маленькая Луна»</span>, воспитанники
                            ...
                            <div>
                                <div>
                                    <p>В 2004 году любимая зрителями камерная «Луна» из уютного гнезда
                                        на Патриарших переселилась в большое, современное, прекрасно оборудованное
                                        театральное здание на Малой Ордынке. Появились новые авторы,
                                        режиссеры, жанры, подрастает талантливая молодежь.
                                    </p>
                                    <p>В июле 2022 года художественным руководителем театра стал народный артист
                                        России Евгений Владимирович Герасимов. Сергей
                        ...
                        <div className={styles.infoBlock_2_44_el11}> <img src={prez}/></div>
                            <div>
                                ...
                                <div className={styles.inf_1}>
                                    ...
                                    <p>Народный артист России, заслуженный деятель искусств России</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.infoBlock_2_4_mob}>
                        ...
                        <div className={styles.infoBlock_2_5}>
                            <div>
                                <h2 className={styles.infoBlock_2_5_tage}>История здания «Театра Луны»</h2>
                                <p className={styles.infoBlock_2_5_inf}>Здание в стиле модерн было спроектировано архитектором И.И.
                                    Кондаковым и заложено в 1910 году.
                                    Открытие состоялось в 1912 году и в нем располагался
                                    "Дом Товарищества Учительского института".</p>
                                <p className={styles.infoBlock_2_5_infName}>Архитектор И. И. Кондаков</p>
                        ...
                        <div className={styles.infoBlock_2_7}>
                            <div>
                                ...
                                На строительство здания <span>средства собирали по всей стране</span>,
                                продавая открытки с видами памятников и изображением произведений
                                мирового искусства. Однако, большую часть средств дали благотворители,
                                а не открытки. Но сумма сбора от их продаж позволила купить библиотеку 
                                и меблировку
                        ...
                        <div className={styles.infoBlock_2_7}>
                            <div>
                                <div className={styles.infoBlock_2_7_el}>
                                    <div>1950-1960</div>
                                    <div>в здании театра был райвоенкомат Москворецкого
                                        района Москвы</div>
                                </div>
                                <div className={styles.infoBlock_2_7_el}>
                                    <div>1970-1980</div>
                                    <div>при клубе Первой образцовой типографии имени
                                    А.А. Жданова, здесь располагался оркестр русских народных инструментов</div>
                                </div>
                                <div className={styles.infoBlock_2_7_el}>
                                    <div>1990-e</div>
                                    <div>в здании было училище №28, где готовили электромонтажников, а также клуб завода "Гознак"
                                    и "Театр Комедии"</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={styles.infoBlock_2_8}>
                            <div>
                                <div className={styles.infoBlock_2_8_img22}><div className={styles.infoBlock_2_8_img2}></div></div>
                                <div className={styles.infoBlock_2_8_block_el_2}>
                                    <div className={styles.infoBlock_2_8_txt}>В 2004 году Правительство Москвы передало здание «Театру Луны»,
                                        куда труппа переехали из подвального помещения в Большом
                                        Козихинском переулке.</div>
                                        <div className={styles.infoBlock_2_8_img23}><div className={styles.infoBlock_2_8_img1}></div></div>
                                </div>
                            </div>
                        </div>
